      ...
      React.createElement("div", {className: "col-md-4 "}, 
        React.createElement("div", {id: "assignment_dir", className: "panel panel-default"}, 
          React.createElement("div", {className: "panel-heading"}, 
            React.createElement("h3", {className: "panel-title"}, "Assignment Library")
          ), 
          React.createElement("div", {className: "panel-body"}, 

            React.createElement("form", {role: "form", className: "search_container"}, 
                React.createElement("div", {className: "form-group"}, 
                  React.createElement("input", {type: "text", className: "form-control", id: "search", placeholder: "Search..."})
                ), 
                React.createElement("button", {type: "submit", className: "btn btn-success"}, "Go")
            ), 
        ...
        React.createElement("script", {type: "text/babel", src: "scripts/example.jsx"})
      )
    )
    );
  }
...
ReactDOM.render(React.createElement(AssignmentBox, {url: "/assignments", pollInterval: 2000}), document.getElementById('content'));

var UserContainer = React.createClass({displayName: "UserContainer",
  render: function(){
    return (
      React.createElement("div", {className: "col-md-4"}, 
        React.createElement("div", {className: "userContainer"}, 
          React.createElement("div", {className: "text-container"}, 
              React.createElement("ul", {className: "col-center"}, 
                React.createElement("li", null, React.createElement("h1", null, "Are you a")), 
                React.createElement("li", null, 
                    React.createElement("a", {href: "/pages/teacher.html"}, 
                      React.createElement("button", {type: "button", className: "btn btn-lg btn-primary"}, "Teacher")
                    )
                ), 
                React.createElement("li", null, React.createElement("h3", null, "or a")), 
                React.createElement("li", null, 
                  React.createElement("a", {href: "/pages/student.html"}, 
                    React.createElement("button", {type: "button", className: "btn btn-lg btn-primary"}, "Student?")
                  )
                )
              )
          )
...
ReactDOM.render(React.createElement(UserContainer, null),document.getElementById('user-select'));
