...
var UserContainer = React.createClass({displayName: "UserContainer",
  render: function(){
    return (
      ...
      React.createElement("div", {className: "col-md-4"}, 
        React.createElement("div", {className: "userContainer panel panel-primary"}, 
          React.createElement("div", {className: "panel-heading"}, 
            React.createElement("h4", null, "Which are you?")
          ), 
          React.createElement("div", {className: "text-container"}, 
              React.createElement("ul", {className: "col-center center panel-body"}, 
